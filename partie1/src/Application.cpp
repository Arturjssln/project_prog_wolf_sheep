...
//    mStats = new Stats;
	...
	simulationBackground.setOutlineColor(sf::Color::Black);
    simulationBackground.setOutlineThickness(5);
    simulationBackground.setTexture(&getAppTexture(getAppConfig().simulation_world_texture));
...
void Application::addGraph(std::string const& /*unusedTitle*/, std::vector<std::string> const& /*unusedSeries*/, double /*unusedMin*/, double /*unusedMax*/)
{
...
void Application::zoomViewAt(sf::Vector2i const& /*unusedPixel*/, float zoomFactor)
{
