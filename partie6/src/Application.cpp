...
void Application::run()
{
    ...
    statsBackground.setFillColor(sf::Color(128, 128, 128, 50));
...
void Application::handleEvent(sf::Event event, sf::RenderWindow& window)
{
    ...
    case sf::Event::KeyPressed:
        ...
        // Toggle automatic generator mode
        case sf::Keyboard::A:
            switchAutomaticGenerator();
            break;
...
void Application::switchAutomaticGenerator()
{
	getAppConfig().switchAutomaticGenerator();
	chooseBackground();
}
