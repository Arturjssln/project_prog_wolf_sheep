...
class LivingEntity : public Obstacle {
  public:
    ...
    virtual void addSheep(std::vector<LivingEntity*>& tab, int numTroupeau) = 0;
    virtual void addWolf(std::vector<LivingEntity*>& tab, int numTroupeau) = 0;
